...
public class EventDataElement implements Serializable,
	...
	public void setRecepieId(String recepieId) {
	...
	public EventDataElement(String vin, String recepieId, String description) {
		super();
	...
	//	this.latitude = Double.parseDouble(latitude);
		...
		//this.geoHash = this.longitude+ this.latitude+"";
